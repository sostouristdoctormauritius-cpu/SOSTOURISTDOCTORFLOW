...
type CatchErrorsType = "always" | "dev" | "prod" | "never"

interface Props {
  children: ReactNode
  catchErrors: CatchErrorsType
}
...
export function withSOSErrorBoundary<P extends object>(
  WrappedComponent: React.ComponentType<P>,
  catchErrors: CatchErrorsType = "always",
) {
  return function WithErrorBoundaryWrapper(props: P) {
    return (
      <ErrorBoundary catchErrors={catchErrors}>
